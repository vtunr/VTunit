...
function(generate_test_runner array_c_file)
	foreach(dir ${array_c_file})
	  ...
	  execute_process(COMMAND python ${CMAKE_SOURCE_DIR}/vtunit/generator/test_runner_generator.py --test_file ${dir})
	endforeach()
endfunction()
...
function(generate_mock test_file)
	...
	execute_process(COMMAND python ../vtunit/generator/mock_generator.py --test_file ${test_file} --mock_prefix mock_ --include ${dirs})
endfunction()
